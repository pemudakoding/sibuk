<?php
    ...
    // $dataSiswa  = mysqli_fetch_object(mysqli_query($koneksi,"SELECT * FROM siswa JOIN kelas ON siswa.id_kelas = kelas.id_kelas WHERE kelas.id_kelas = '$id_kelas' AND status_pendidikan = 'aktif' ORDER BY siswa.nama_depan asc"));
...
<body>
    ...
    <?php while($dataSiswa =  mysqli_fetch_object(mysqli_query($koneksi,"SELECT * FROM siswa JOIN kelas ON siswa.id_kelas = kelas.id_kelas WHERE kelas.id_kelas = '$id_kelas' AND status_pendidikan = 'aktif' ORDER BY siswa.nama_depan asc limit 1,3"))) : ?>
    <?php 
                    ...
                    <table class="default-table tempat-tinggal">
                        ...
                        <tr>
                            ...
                            <td style="position: relative; top: 2px;">
                                ...
                                <?php
                                    if($dataSiswa->alamat_tersebut == 'Lainnya' || $dataSiswa->alamat_tersebut == '' || $dataSiswa->alamat_tersebut == '-'  || $dataSiswa->alamat_tersebut != '' ):
                                ?>
                ...
                <div class="ket-pribadi ket-pendidikan-prev">
                    ...
                    <table class="table-nested">
                        ...
                        <tr class="nested-data">
                            ...
                            <td style="position: relative; top: 5px; display: flex; align-items: center;">
                             <?php
                                if($dataSiswa->asal_sekolah == '' || $dataSiswa->asal_sekolah == '-' || $dataSiswa->asal_sekolah != ''):
                            ?>
